...
import { getUserSummary, formatUserSummary, formatUserSummaryJSON } from "./get-user-summary.js";
...
async function main() {
	...
	if (args.length < 2) {
		...
		console.log("  npm run user:summary 354823920010002432 1254694808228986912");
		console.log("  npm run user:summary 354823920010002432 1254694808228986912 --json");
		console.log("");
		console.log("Alternative usage:");
		console.log("  bun src/scripts/get-user-summary.ts <user-id> <guild-id> [--json]");
		console.log("  npx tsx src/scripts/get-user-summary.ts <user-id> <guild-id> [--json]");
		process.exit(1);
	}
