...
async function debugDatabase() {
  ...
  try {
    ...
    const queryResult = await db.query('SELECT * FROM messages WHERE id = $id', { id: '1234567890123456789' });
    ...
    const guildMessages = await db.query('SELECT * FROM messages WHERE guild_id = $guild_id LIMIT 5', { guild_id: '1254694808228986912' });
