...
async function diagnoseDatabase() {
  ...
  try {
    ...
    const fieldSelect = await db.query('SELECT id, content FROM messages LIMIT 3');
    ...
    const guildSelect = await db.query('SELECT * FROM messages WHERE guild_id = "1254694808228986912" LIMIT 3');
    ...
    const channelSelect = await db.query('SELECT * FROM messages WHERE channel_id = "1254697312052187178" LIMIT 3');
