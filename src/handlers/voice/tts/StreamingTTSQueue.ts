...
export class StreamingTTSQueue {
	...
	/**
	 * Set the request start time for response time metrics
	 */
	public setRequestStartTime(startTime: number): void {
		this.requestStartTime = startTime;
		this.totalChunksQueued = 0; // Reset counter for new request
	}
